  ...
  template: `
    <div class="mx-auto max-w-5xl">
      <div class="mx-auto max-w-lg rounded-xl border border-[#e8e8e3] bg-white p-8 text-center shadow-[0_1px_3px_rgba(15,18,24,0.06)] dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <p class="mt-2 text-sm text-[#63676c] dark:text-zinc-400">If payment succeeded, your account plan updates via the Dodo webhook. It can take a moment to reflect.</p>
