...
const PLANS = [
  ...
  },
  {
    ...
    annual: "$290",
    note: "Creators",
    features: ["5 channels", "Unlimited posts / mo", "AI copilot & picture editor", "3 short AI videos / mo"],
  ...
  },
  {
    ...
    annual: "$390",
    note: "Small brands",
    features: ["10 channels", "Unlimited teammates", "100 AI images / mo", "10 short AI videos / mo"],
    cta: "Start scheduling",
    featured: false,
    href: "/signup",
    external: false,
  },
  {
    ...
    annual: "$490",
    note: "Businesses",
    features: ["30 channels", "Unlimited teammates", "300 AI images / mo", "30 short AI videos / mo"],
    cta: "Start scheduling",
    featured: false,
    href: "/signup",
    external: false,
  },
  {
    ...
    annual: "$990",
    note: "Agencies",
    features: ["100 channels", "Unlimited teammates", "500 AI images / mo", "60 short AI videos / mo"],
    cta: "Start scheduling",
    featured: true,
    href: "/signup",
    external: false,
...
const FAQS = [
  ...
  },
  {
    ...
    a: "AI copilot and the picture editor are on Cloud plans. AI image credits start on Team. Every Cloud plan includes short AI video credits at different monthly caps.",
  },
  {
